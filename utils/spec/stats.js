...
describe('median()', function () {
  ...
  it('correctly computes median of array of numbers', function () {
    ...
    expect(median([0, -40, 12, -62, 42])).to.equal(0);
    expect(median([111860, -40, 12, -62, 42, 27])).to.equal(19.5);
    ...
    expect(median([Number.POSITIVE_INFINITY, Number.NEGATIVE_INFINITY, 42, 62, 42])).to.equal(42);
  });
